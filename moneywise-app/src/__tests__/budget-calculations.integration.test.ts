 ...
 *
 * This file tests the core business logic of our budget application.
 * It demonstrates testing mathematical operations and edge cases.
 *
 * LEARNING OBJECTIVES:
...
describe('Budget Calculations Integration Tests', () => {
    ...
    it('should handle basic money calculations correctly', () => {
        ...
        expect(remaining).toBeCloseTo(249.50, 2);    // $249.50 remaining (2 decimal precision)
     ...
     *
     * Tests what happens when user spends more than planned.
     * This is a common real-world scenario that must be handled correctly.
     *
     * WHAT THIS TEACHES:
     ...
     * - App must handle negative remaining amounts
     * - UI needs to show "over budget" states correctly
     *
     * REAL-WORLD SCENARIO:
    ...
    it('should handle over-budget calculations correctly', () => {
        ...
        expect(remaining).toBeCloseTo(-150.75, 2);   // Negative remaining (over by $150.75)
     ...
     *
     * Tests the dangerous scenario of division by zero.
     * This prevents app crashes when users have no budget set up.
     *
     * WHAT THIS TEACHES:
     ...
     * - New user hasn't set up budget yet
    ...
    it('should handle zero budget calculations safely', () => {
        ...
        // - Use Number.isFinite() to check result
