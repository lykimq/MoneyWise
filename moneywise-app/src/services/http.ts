...
// - On Android physical device. Use 192.168.1.29 to reach the host machine.
// - On iOS simulator and web, 'http://localhost:3000/api' works. http://192.168.1.29:3000/api
const API_BASE_URL = (() => {
