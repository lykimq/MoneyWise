 ...
 *
 * This is a simple demonstration test to help you learn Jest testing
 * fundamentals. It verifies that our Jest configuration is working correctly.
 *
 * LEARNING OBJECTIVES:
...
describe('Demo Integration Test', () => {
     ...
     *
     * This tests simple, immediate operations. No waiting for promises,
     * API calls, or timers.
     *
     * WHAT THIS TEACHES:
     ...
     *
     * This tests operations that return promises. Many real-world operations
     * are async (API calls, file operations, etc.).
     *
     * WHAT THIS TEACHES:
     ...
     *
     * This shows different ways to make assertions in Jest. Different matchers
     * are useful for different types of comparisons.
     */
